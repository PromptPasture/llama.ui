<script lang="ts">
  ...
  const generationKeys: ConfigurationKey[] = ['temperature', 'top_k', 'top_p', 'min_p', 'max_tokens'];
  const samplerKeys: ConfigurationKey[] = ['samplers', 'dynatemp_range', 'dynatemp_exponent', 'typical_p', 'xtc_probability', 'xtc_threshold'];
  const penaltyKeys: ConfigurationKey[] = ['repeat_last_n', 'repeat_penalty', 'presence_penalty', 'frequency_penalty', 'dry_multiplier', 'dry_base', 'dry_allowed_length', 'dry_penalty_last_n'];
</script>
